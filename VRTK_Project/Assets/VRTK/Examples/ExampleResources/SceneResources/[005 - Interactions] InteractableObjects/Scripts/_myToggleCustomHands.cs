namespace VRTK.Examples
{
    ...
    public class _myToggleCustomHands : MonoBehaviour
    {
        ...
        public GameObject leftColliders;
        public GameObject rightColiders;
        ...
        protected virtual void ToggleAvatarVisibility()
        {
            if (leftHandAvatar != null)
            {
                ...
                leftRenderer.enabled = state;
                leftColliders.SetActive(state);
            }
            if (rightHandAvatar != null)
            {
                //rightHandAvatar.SetActive(state);
                rightRenderer.enabled = state;
                rightColiders.SetActive(state);
            }
        }
